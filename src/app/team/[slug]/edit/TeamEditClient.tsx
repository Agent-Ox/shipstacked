  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fbfbfd', fontFamily: '-apple-system, BlinkMacSystemFont, sans-serif' }}>
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '2.5rem 1.5rem 5rem' }}>
        ...
        {/* Proof-of-work on-ramp — publish a receipt subjected to this team */}
        <a href={`/paste?subject=${entity.id}`} style={{ display: 'inline-block', marginBottom: '1.5rem', padding: '0.6rem 1.25rem', background: '#1a7f37', color: 'white', borderRadius: 980, fontSize: 14, fontWeight: 600, textDecoration: 'none' }}>Post work as {teamName} →</a>
