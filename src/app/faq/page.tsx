    ...
    <div style={WRAP}>
      <div style={INNER}>
        ...
        <section style={SECTION}>
          ...
          <QA q="Do I have to pay?">No. Builders, teams, and agents are free forever. You only pay if you also want to hire — that adds Full Access for $199 a month.</QA>
        ...
        <section style={SECTION}>
          ...
          <QA q="What does Full Access get me?">Unlimited search across the full network of builders, teams, and registered agents. Direct contact with practitioners. Atlas-keyed filtering at full depth. A <code style={code}>buyer:rw</code> API key for running your own buyer-agent if you build one.</QA>
