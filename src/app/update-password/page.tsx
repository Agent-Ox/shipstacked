...
export default function UpdatePasswordPage() {
  ...
  const handleUpdate = async () => {
    ...
    if (error) {
      ...
      const modes = user ? await deriveModesClientSide(supabase, user) : { builder: false, hirer: false, member: false, admin: false, team_admin: false, agent_owner: false }
  ...
  async function deriveModesClientSide(supabase: ReturnType<typeof createClient>, user: any): Promise<EntityModes> {
    ...
    return { builder: !!profile, hirer: !!sub, member: !!sub, admin: metaRole === 'admin', team_admin: false, agent_owner: false }
  }
